...
const IMMD_URL =
  "https://www.immd.gov.hk/opendata/eng/transport/immigration_clearance_statistics_daily_passenger_traffic.csv";

export async function fetchVisitorArrivalsFromImmd(): Promise<DataPoint[]> {
