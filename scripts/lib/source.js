export const URLs = {
    censtatd: (id) => `https://www.censtatd.gov.hk/api/get.php?full_series=1&id=${id}&lang=tc`,
    ...
    birthsCsv: "https://www.dh.gov.hk/datagovhk/ncdd/Number%20of%20Known%20Births%20for%20Different%20Sexes%20and%20Crude%20Birth%20Rate%201981-2024(tc).csv",
    ...
    rvdCompletionsCsv: "https://www.rvd.gov.hk/datagovhk/Dom_Completions_and_Forecast_Completions_by_District_Eng.csv",
    fstbOverviewCsv: "https://www.fstb.gov.hk/datagovhk/tsyb/financial-statistics/tc/fin-stats_overview_a_tc.csv",
    hkmaInterbankLiquidity: "https://api.hkma.gov.hk/public/market-data-and-statistics/daily-monetary-statistics/daily-figures-interbank-liquidity"
};
